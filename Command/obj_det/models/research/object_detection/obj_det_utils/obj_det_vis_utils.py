...
from obj_det.models.research.object_detection.core import standard_fields as fields
from obj_det.models.research.object_detection.obj_det_utils import shape_utils
from apollo.visualization import draw_bounding_box_on_image
      ...
      if scores is None:
        ...
        if not skip_labels:
          if not agnostic_mode:
            class_int = classes[i]
            class_name = get_class_str(category_index, class_int)
...
def get_class_str(category_index, class_int):
    if class_int in six.viewkeys(category_index):
