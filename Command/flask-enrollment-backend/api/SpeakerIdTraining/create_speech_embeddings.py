...
def GetEmbeddingsFromListFile (list_file, max_duration=30):
...
def parseCommandLine ():
    ...
    parser.epilog='''Example:
        %s enroll_list.csv speech-embeddings.pkl 30
        ''' % (sys.argv[0])
...
if __name__ == "__main__":
    ...
    ## Extract embeddings
    (trainX, trainy) = GetEmbeddingsFromListFile (args.speechFileList, int (args.maxAudoSec))
