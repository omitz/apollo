...
#DEFAULT_MODELDIR = '/share/Projects/speech-recognition/pre-trained-models/kaldi-generic-en-tdnn_250-r20190609'
#DEFAULT_MODELDIR = '/share/Projects/speech-recognition/pre-trained-models/kaldi-generic-en-tdnn_fl-r20190609'
DEFAULT_MODELDIR = '/share/Projects/speech-recognition/pre-trained-models/kaldi-generic-en-tdnn_f-r20190609'

parser = OptionParser("usage: %prog [options] foo.wav [bar.wav ...]")

parser.add_option("-m", "--model-dir", dest="modeldir", type = "str",
