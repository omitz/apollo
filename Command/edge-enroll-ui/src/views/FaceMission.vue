              ...
              <v-toolbar flat>
                ...
                <v-spacer></v-spacer>
                    <v-btn
                      ...
                      dark
                      class="mb-2"
                      @click="downloadFaceMission"
                    >
                      Download Face Mission
                    </v-btn>
...
*/
  ...
  methods: {
    ...
    downloadFaceMission() {
      ...
      for (var i = 0; i < this.selected.length; i++) {
        ...
        var data_url =
          "createmodel/mission/download?analytic=faceid&user=Wole&mission="+
        ...
        this.apiGet(data_url)
          ...
          .then((blob) => {
            console.log("Download face missions successful=");
  ...
  created() {
    ...
    var data_url = 'createmodel/mission?analytic=faceid&user=Wole';

    this.apiGet(data_url)
      .then((response) => response.json())
      .then((data) => {
        console.log("upload file!!!!!! data=" + data.missions[0]);
