...
*/
      ...
      for (var i = 0; i < this.selected.length; i++) {
        ...
        var data_url =
          "createmodel/mission?analytic=faceid&user=Wole&vip=" +
      ...
      data_url =
        "createmodel/mission?analytic=faceid&user=Wole&mission=" +
        this.editedItem.name;
      //var data_url = 'createmodel/vip?analytic=faceid&user=Wole&vip=_all_';
  ...
  created() {
    ...
    //curl -X GET "http://localhost:8080/createmodel/vip?analytic=faceid" -H  "accept: */*"
    var data_url = "createmodel/vip?analytic=faceid&user=Wole";
    //var data_url = 'createmodel/vip?analytic=faceid&user=Wole&vip=_all_';
