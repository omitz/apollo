...
from sqlalchemy import Column, Integer, String, BigInteger, ARRAY, TIMESTAMP

from .ModelBase import ModelBase

class ClassifyScene(ModelBase):
    ...
    def serialize(self):
        ...
        if self.top_five_classes:
            top_five_classes_serialized = [self.classes_ori[class_id] for class_id in self.top_five_classes]
        else: 
            top_five_classes_serialized = None

        return {
            "id": self.id,
            "path": self.path,
            "class_hierarchy": self.class_hierarchy,
            "top_five_classes": top_five_classes_serialized,
    ...
    def serialize_v2(self):
        ...
        if self.top_five_classes:
            top_five_classes_serialized = [self.classes[idx] for idx in self.top_five_classes]
        else: 
            top_five_classes_serialized = None
