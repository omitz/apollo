...
def parse_args():
    ...
    parser.add_argument('-o', '--output', help='Directory to write results to')
    ...
    parser.add_argument('--test_folder', default='test_imgs', type=str, help='folder path to input images')
