...
yes | ./show_threshold_study.py 3 50 unknown_scores.pkl faceid_threshold_study
evince faceid_threshold_study.pdf
...
# show threshold studies
yes | ./show_threshold_study.py 2 50 unknown_scores.pkl faceid_threshold_study_small
evince faceid_threshold_study_small.pdf
