#! /usr/bin/env python3
#
# This program takes in a directory containing the speach data.  It then
# does a 5 fold stratified cross validation of the entire data set and
...
if __name__ == "__main__":
    ...
    if (args.maxClassExamples != None):
        ...
        myFile = create_dataset_lists.getEntireDataset (args.vipTopDir, maxExamples)
    else:
        print ("use all data")
        myFile = create_dataset_lists.getEntireDataset (args.vipTopDir)
    ...
    for idx, (train_index, test_index) in enumerate (skf.split (newTrainX, newTrainy)):
        ...
        clf = create_speech_classifier.TrainSVM (trainX, trainy)
