...
//    static final int SAMPLE_RATE = 44100;
    ...
    private static final String LOG_TAG = "Tommy Playback Thread";
    ...
    private void play() {
            ...
            (new AudioTrack.OnPlaybackPositionUpdateListener() {
                    ...
                    public void onPeriodicNotification(AudioTrack track) {
                        if (mListener != null &&
                            ...
                            mListener.onProgress ((track.getPlaybackHeadPosition() * 1000) /
                                                  SAMPLE_RATE);
                        }
                    }
                    @Override
        ...
        audioTrack.setPositionNotificationPeriod (SAMPLE_RATE / 10); // 10 times per second
