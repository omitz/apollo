...
# 2. Install the app
adb uninstall com.caci.apollo.speakerid_celebrity10_model_installer 2> /dev/null || true
adb install speakerid-celebrity10-model-installer/build/outputs/apk/debug/speakerid-celebrity10-model-installer-debug.apk
...
## Start the app
adb shell am start --user 0 -n com.caci.apollo.speakerid_celebrity10_model_installer/.MainActivity
