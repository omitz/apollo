...
public class ImageUtils {
    ...
    private static String TAG = "Tommy ImageUtils";

    static {
        try {
            System.loadLibrary("tensorflow_demo");
        } catch (UnsatisfiedLinkError e) {
            Log.d(TAG, "Native library not found, native RGB -> YUV conversion may be unavailable.");
        }
    }
    ...
    public static void saveBitmap(final Bitmap bitmap) {
        FaceIdFileUtils.saveBitmap(bitmap, "preview.png");
    }
    ...
    public static void convertYUV420SPToARGB8888(
        ...
        if (useNativeConversion) {
            try {
                ...
                Log.d (TAG, "Native YUV420SP -> RGB implementation not found, " +
    ...
    public static void convertYUV420ToARGB8888(
        ...
        if (useNativeConversion) {
            try {
                ...
                Log.d (TAG, "Native YUV420 -> RGB implementation not found, " +
                       "falling back to Java implementation");
                Log.d (TAG, Log.getStackTraceString(e));
                useNativeConversion = false;
            }
    ...
    public static Matrix getTransformationMatrix(
        ...
        if (applyRotation != 0) {
            if (applyRotation % 90 != 0) {
                ...
                Log.d (TAG, "Rotation of %d % 90 != 0 " + applyRotation);
            }
