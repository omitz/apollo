package com.caci.apollo.faceid_celebrity10_model_installer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                String outDir = "/sdcard/atak/tools/datapackage/files/ApolloFaceID-10VIP/";
                    
                try {
                    ZipInputStream inputStream =
                        new ZipInputStream (context.getAssets().open("ApolloFaceID-10VIP.zip"));
