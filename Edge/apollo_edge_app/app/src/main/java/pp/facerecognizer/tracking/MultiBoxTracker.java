...
import pp.facerecognizer.utils.ImageUtils;
...
//        logger.i("Processing %d results from %d", results.size(), timestamp);
    ...
    /**
     * Draw the canvas to save out as a png.
    ...
    public void drawRecognition(Canvas canvas, Recognition recog, RectF pos, Paint boxPaint) {
        ...
        final String labelString = String.format("%s %.2f", recog.getTitle(), recog.getConfidence());
