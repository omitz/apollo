...
//        String apiRootUrl = "http://yourIPAddress:8080/";
    ...
    public static void queueUploadViaApi(Activity activity,
                                         String fullLocalFilepath,
                                         String s3inputDir,
                                         NetworkTask.AsyncResponse delegate,
                                         Boolean verbose) {
        ...
        if (verbose) {
            // Helpful Toast message for debugging
        ...
        // Upload to S3
        NetworkTaskUpload uploadTask = new NetworkTaskUpload(activity.getApplicationContext(), fullLocalFilepath, null);
        if (delegate != null) {
