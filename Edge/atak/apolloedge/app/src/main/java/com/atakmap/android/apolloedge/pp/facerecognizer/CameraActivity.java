...
public abstract class CameraActivity extends AppCompatActivity
    ...
    */
    ...
    protected boolean hasPermission(String[] permissionsList) {
    ...
    protected void setFragment() {
                ...
                CameraConnectionFragment.newInstance(
                        new CameraConnectionFragment.ConnectionCallback() {
                            ...
                            public void onPreviewSizeChosen(Size size, int rotation) {
                                ...
                                Log.i("camsize", "previewHeight: " + previewHeight);
                                previewWidth = size.getWidth();
                                Log.i("camsize", "previewWidth: " + previewWidth);
        ...
        Log.i("camsize", "getDesiredPreviewFrameSize: " + getDesiredPreviewFrameSize());
