...
package  com.atakmap.android.apolloedge.pp.facerecognizer.wrapper;
...
public class FaceNet {
    private static final String MODEL_FILE = "file:///android_asset/face/facenet.pb";
...
//        Visualize the faces cropped out of the original images
//        saveBitmap(bitmap, String.valueOf(Calendar.getInstance().getTimeInMillis()), (Location) null);
