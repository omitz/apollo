...
// #define IMAGEUTILS_METHOD(METHOD_NAME) \
//   Java_com_atakmap_android_apolloedge_pp_facerecognizer_env_ImageUtils_##METHOD_NAME  // NOLINT

#define IMAGEUTILS_METHOD(METHOD_NAME)                                  \
  Java_com_atakmap_android_apolloedge_pp_facerecognizer_utils_ImageUtils_##METHOD_NAME  // NOLINT
