...
./gradlew --console plain --no-daemon app:assembleCivDebug
cd -
APK=$(ls -1rt helloworld/app/build/outputs/apk/civ/debug/*.apk  | tail -1)
mv $APK atak_helloworld_with_speakerId_datafeed_debug.apk

##
echo "To intall apollo plugin, do:"
echo "  adb uninstall com.atakmap.android.helloworld.plugin"
echo "  adb install atak_helloworld_with_speakerId_datafeed_debug.apk"
