...
public class HelloWorldDropDownReceiver extends DropDownReceiver implements
    ...
    public HelloWorldDropDownReceiver(final MapView mapView,
        ...
        final Button faceID_video = helloView.findViewById(R.id.faceID_video);
        faceID_video.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {

                // TC 2021-04-10 (Sat) -- add faceID here
                Intent intent = new Intent();
                intent.setClassName
                    ("com.atakmap.android.helloworld.plugin",
                     "com.atakmap.android.helloworld.faceIdOnVideo.FaceIdVideoActivity");
        ...
        final Button faceID_image = helloView.findViewById(R.id.faceID_image);
        faceID_image.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                intent.setClassName
                    ("com.atakmap.android.helloworld.plugin",
                     "com.atakmap.android.helloworld.faceIdOnImage.FaceIdImageActivity");
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK); // this shows a new task
                getMapView().getContext().startActivity(intent);
