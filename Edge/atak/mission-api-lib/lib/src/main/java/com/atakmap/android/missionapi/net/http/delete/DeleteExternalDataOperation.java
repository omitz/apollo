 ...
 *
 */
public class DeleteExternalDataOperation extends AbstractOperation {
    private static final String TAG = "DeleteExternalDataOperation";
    ...
    public void execute(Context context, AbstractRequest r, Bundle b)
        ...
        // Get request data
        DeleteExternalDataRequest req = (DeleteExternalDataRequest) r;
        ...
        for (String uid : req.getUIDs()) {
            ...
            String message = String.format(LocaleUtil.getCurrent(),
                    "Deleting %d of %d external data (%d%%) - %s", itemCount,
                    req.getUIDs().size(),
