 ...
 */
public class GetFeedSubsOperation extends AbstractOperation {

    private static final String TAG = "GetFeedSubsOperation";
    ...
    public void execute(Context context, AbstractRequest r, Bundle b)
        ...
        try {
            ...
            Log.e(TAG, "Failed to get feed users: " + r.getFeedName(), e);
