...
/**
 * Operation to HTTP DELETE a log
 *
 */
public class DeleteFeedLogsOperation extends AbstractOperation {

    private static final String TAG = "DeleteFeedLogsOperation";

    @Override
    public void execute(Context context, AbstractRequest r, Bundle b)
            throws ConnectionException, DataException {

        DeleteFeedLogsRequest req = (DeleteFeedLogsRequest) r;
