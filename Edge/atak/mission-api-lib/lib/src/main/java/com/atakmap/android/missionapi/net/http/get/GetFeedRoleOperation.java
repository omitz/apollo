...
/**
 * Generic operation to GET the user's feed role
 */
public class GetFeedRoleOperation extends AbstractOperation {

    private static final String TAG = "GetFeedRoleOperation";
    ...
    public void execute(Context context, AbstractRequest r, Bundle b)
        ...
        try {
            ...
            Log.e(TAG, "Failed to get feed role: " + r.getFeedName(), e);
