...
/**
 * Operation to modify a user's role in the feed
 *
 */
public class PutFeedRoleOperation extends AbstractOperation {
    
    private static final String TAG = "PutFeedRoleOperation";

    @Override
    public void execute(Context context, AbstractRequest r, Bundle b)
            throws ConnectionException,
            DataException {
        serverRequest(r, OpType.PUT, b);
    }
}
