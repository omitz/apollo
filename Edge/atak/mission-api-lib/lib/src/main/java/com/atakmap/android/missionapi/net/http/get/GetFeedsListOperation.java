...
/**
 * Generic operation to GET a feed
 */
public class GetFeedsListOperation extends AbstractOperation {

    private static final String TAG = "GetFeedsListOperation";
    ...
    public void execute(Context context, AbstractRequest r, Bundle b)
        ...
        try {
            ...
            Log.e(TAG, "Failed to get feed list: " + r.getFeedName(), e);
