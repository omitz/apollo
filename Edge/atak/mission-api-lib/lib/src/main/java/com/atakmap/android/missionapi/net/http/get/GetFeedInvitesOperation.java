...
/**
 * Get all feeds the user has been invited to while offline
 */
public class GetFeedInvitesOperation extends AbstractOperation {

    private static final String TAG = "GetFeedInvitesOperation";
    ...
    public void execute(Context context, AbstractRequest r, Bundle b)
        ...
        try {
            ...
            Log.e(TAG, "Failed to get feed: " + r.getFeedName(), e);
