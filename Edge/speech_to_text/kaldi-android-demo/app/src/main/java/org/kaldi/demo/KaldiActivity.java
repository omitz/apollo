...
//        findViewById(R.id.languageGroup).check(R.id.englishBtn);
        ...
        // findViewById(R.id.englishBtn).setOnClickListener(new View.OnClickListener() {
        //     @Override
        ...
        // findViewById(R.id.russianBtn).setOnClickListener(new View.OnClickListener() {
        //     @Override
        //     public void onClick(View view) {
...
//        radioSexButton.toggle();
    ...
    public void englishBtnHandler (View v) {
        setUiState(STATE_START);
        m_language = "english";
        new SetupTask(this).execute(m_language);
        Toast.makeText(getApplicationContext(), "English Selected",
                       Toast.LENGTH_SHORT).show();
    ...
    public void russianBtnHandler (View v) {
        ...
        m_language = "russian";
        new SetupTask(this).execute(m_language);
        Toast.makeText(getApplicationContext(), "Russian Selected",
                       Toast.LENGTH_SHORT).show();
    }
    ...
    private static class RecognizeTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                switch (params[0]) {
                case "english":
                    ais = activityReference.get().getAssets().open("10001-90210-01803-en.wav");
                    break;
                case "russian":
                    ais = activityReference.get().getAssets().open("10001-90210-01803-ru.wav");
                    break;
                default:
                    ais = activityReference.get().getAssets().open("10001-90210-01803.wav");
                    break;
                }
...
//                new SetupTask(this).execute();
    ...
    private void setUiState(int state) {
        switch (state) {
            case STATE_START:
                ...
                findViewById(R.id.englishBtn).setEnabled(true);
                findViewById(R.id.russianBtn).setEnabled(true);
                break;
            case STATE_READY:
            ...
            case STATE_FILE:
                ...
                findViewById(R.id.recognize_mic).setEnabled(false);
                findViewById(R.id.recognize_file).setEnabled(false);
                findViewById(R.id.englishBtn).setEnabled(false);
                findViewById(R.id.russianBtn).setEnabled(false);
                break;
            case STATE_MIC:
    ...
    public void recognizeFile() {
        ...
        new RecognizeTask(this, resultView).execute (m_language);
    }
