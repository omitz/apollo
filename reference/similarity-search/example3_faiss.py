...
#
# This example demonstrates Inverted File Index + Product Quantization
#
# Maximum resident set size (kbytes): 221368
#
...
print ("========================================================")
print ("  FAISS IVF + PQ (clustering method with quantization)")
print ("========================================================")
...
##########################################
#   IVF (clustering) + PQ (quantization) Indexing: 
##########################################
print("Inexing data...")
start = time.time()
...
m = 4                            # number of subquantizers. d should be a multiple of m
nbits = 8                        # bits allocated per subquantizer (must be 8, 12 or 16).
